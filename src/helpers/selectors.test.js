...
const state = {
  ...
  appointments: {
    ...
    "2": { 
      id: 2, 
      time: "1pm",
      interview: { student: "Michael Blake", interviewer: 2 }
    },
    "3": {
      id: 3,
      time: "2pm",
...
test("getInterviewersForDay returns an array containing the correct interviewer objects for -MONDAY", () => {
...
test("getInterviewersForDay returns an array containing the correct interviewer objects for -TUESDAY", () => {
